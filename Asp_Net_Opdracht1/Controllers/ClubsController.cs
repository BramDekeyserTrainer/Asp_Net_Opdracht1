...
namespace Asp_Net_Opdracht1.Controllers
{
    public class ClubsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Club_Naam,Club_Adres")] Club club)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Club_Naam,Club_Adres")] Club club)
        {
            if (id != club.Id)
            {
                return NotFound();
